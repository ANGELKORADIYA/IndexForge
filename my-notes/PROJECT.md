...
**Technical Decisions:**
- **Fuzzy Arm:** Pure-Rust character trigrams (no symspell required initially). Space-padded trigrams handle boundary matching. 1-char typo only invalidates 3/N trigrams, giving natural tolerance.
